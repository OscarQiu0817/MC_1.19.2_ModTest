...
@Mod.EventBusSubscriber(modid = OscarMod.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class ModCreativeModeTabs {
    ...
    public static void registerCreativeModeTabs(CreativeModeTabEvent.Register event){
        // 建立客製化標籤頁物件
        OSCAR_TAB = event.registerCreativeModeTab(new ResourceLocation(OscarMod.MODID, "oscar_tab"),
                // 選定 圖標 與 顯示的標題符號
